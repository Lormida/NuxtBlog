...
<template>
    <TemplatePost>
        <template #title>
            <h1 text-5xl font-bold text-anti-main-accent>Popular Posts</h1>
        </template>
                ...
                <div relative rounded-xl>
                    <Listbox v-model="selectedPerson">
                        ...
                        <Transition name="list">
                            <ListboxOptions absolute w-full class="min-w-[200px]" border-2 border-neutral top-20 left-0>
                                <ListboxOption
        ...
        <template #cards>
            <MoleculeCardPost v-for="card in 10" :name="card" :key="card" round :src="sourceImage" />
        </template>
    </TemplatePost>
</template>
